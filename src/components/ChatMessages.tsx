            ...
            <p
              className={`${
                message.senderId === currentUser.id
                  ? "bg-[#5183fe] rounded-[20px] rounded-tr-none p-[12px_20px]"
                  : "p-[12px_20px] bg-[rgba(17,25,40,0.3)] rounded-[20px] rounded-tl-none"
              }`}
            >
              {message.content[0][currentUser.preferredLanguage]}{" "}
            </p>
            <span
              className={
                message.senderId === currentUser?.id
                  ? "text-end font-thin text-xs"
                  : "font-thin text-xs"
              }
            >
